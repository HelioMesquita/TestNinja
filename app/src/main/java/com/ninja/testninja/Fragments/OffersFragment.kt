...
class OffersFragment : Fragment(), StarView, RequestCallBack, SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onRefresh() {
        WebClient.responseOffersRefresh(creatOffers.linksOffer(), this)
    }

    override fun onSuccess(obj: Any) {
        popularRecyclerView(obj)
        creatOffers = obj as CreatOffers
    }
    ...
    override fun startRequestView(obj: Any) {
        WebClient.responseOffers((obj as StartLinks).linksOffer(), this)
    }

    lateinit var creatOffers: CreatOffers
